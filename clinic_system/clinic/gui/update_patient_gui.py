...
class UpdatePatientGUI(QWidget):
    def __init__(self, controller: Controller, parent, current_phn: int):
        super().__init__()
        self.controller = controller
        self.parent = parent
        self.current_phn = self.parent.current_phn
    ...
    def update_button_clicked(self):
        ...
        try:
            ...
            new_patient = self.controller.update_patient(self.current_phn ,phn, name, birth_date, phone, email, address)
            QMessageBox.information(self.parent, "Success", "You have updated Patient")
